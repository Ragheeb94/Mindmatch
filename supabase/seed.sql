-- Run after migrations to populate test therapists
-- First create auth users manually in Supabase Dashboard > Authentication, then:
...
insert into public.therapist_profiles
  (user_id, license_number, crpo_status, photo_url, bio, years_experience,
   ...
   specialties, client_focus_text, therapy_approaches, contact_email, is_active)
values
  ('00000000-0000-0000-0000-000000000001', 'RP001234', 'verified',
   ...
   ARRAY['EMDR','Attachment-Based','CBT'],
  ...
  ('00000000-0000-0000-0000-000000000002', 'RP002345', 'verified',
   ...
   ARRAY['CBT','Person-Centered','IFS'],
   'michael@example.com', true),
  ...
  ('00000000-0000-0000-0000-000000000003', 'RP003456', 'verified',
   ...
   ARRAY['DBT','Mindfulness-Based (MBCT)','Trauma-Focused'],
   'ksenia@example.com', true);
